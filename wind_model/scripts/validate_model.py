...
Run after fetch_month.py. Produces four plots in ./diagnostics/:
  ...
  - altitude_params.png   σ_u(z) and L(z) vs altitude
"""
...
from wind_model.cds_fetch import load_or_fetch
from wind_model.eof import EOFModel
from wind_model.von_karman import VonKarmanFilter, sigma_u, scale_length, L_FREE_ATM
