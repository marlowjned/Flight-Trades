...
from wind_model.von_karman import sigma_u, scale_length, VonKarmanFilter
...
class TestSigmaU:
    ...
    def test_sigma_above_surface(self):
        ...
        from wind_model.von_karman import MILSPEC_SIGMA_TABLE
...
class TestScaleLength:
    ...
    def test_scale_length_free_atm(self):
        ...
        from wind_model.von_karman import L_FREE_ATM
